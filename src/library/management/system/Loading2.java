...
public class Loading2 extends javax.swing.JFrame {
                ...
                for(int i=1; i<=100; i++){
                    try {
                        ...
                        if(jProgressBar1.getString().equals("50%")){
                            jlb.setText("Loading Modules......");
                        }
                        if(jProgressBar1.getString().equals("25%")){
                            jlb.setText("Connacting Database......");
                        }
                        if(jProgressBar1.getString().equals("95%")){
                            jlb.setText("Launching Application......");
                        }  
    ...
    private void initComponents() {
        ...
        jlb.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jPanel1.add(jlb, new org.netbeans.lib.awtextra.AbsoluteConstraints(388, 410, 250, 20));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 650, 430));
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 430, 660, 20));
